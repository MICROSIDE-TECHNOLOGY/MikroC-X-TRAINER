...
;MotorDCInfrarrojo.c,26 :: 		ADC_Init_Advanced(_ADC_INTERNAL_REF);      //Voltaje de referencia a VDD y GND
	CLRF        FARG_ADC_Init_Advanced_reference+0 
	CALL        _ADC_Init_Advanced+0, 0
;MotorDCInfrarrojo.c,28 :: 		while (1)
L_main0:
;MotorDCInfrarrojo.c,30 :: 		VALOR_ADC = ADC_Get_Sample(3)*1.53;   //Lee el valor del ADC y lo guarda en la variable
	MOVLW       3
	...
	MOVF        R1, 0 
	MOVWF       _VALOR_ADC+1 
;MotorDCInfrarrojo.c,31 :: 		PWM1_Set_Duty (VALOR_ADC);
	MOVF        R0, 0 
	MOVWF       FARG_PWM1_Set_Duty_new_duty+0 
	CALL        _PWM1_Set_Duty+0, 0
;MotorDCInfrarrojo.c,32 :: 		}
	GOTO        L_main0
