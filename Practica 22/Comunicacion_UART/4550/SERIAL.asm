...
;SERIAL.c,23 :: 		TRISB = 0x00;                      //Puerto B como salida
	CLRF        TRISB+0 
;SERIAL.c,24 :: 		LATA4_bit = 0;                     //Pin A4 en estado bajo
	BCF         LATA4_bit+0, BitPos(LATA4_bit+0) 
;SERIAL.c,25 :: 		TRISA4_bit = 0;                    //Pin A4 como salida
	BCF         TRISA4_bit+0, BitPos(TRISA4_bit+0) 
;SERIAL.c,26 :: 		TRISA2_bit = 1;                    //Pin A2 como salida
	BSF         TRISA2_bit+0, BitPos(TRISA2_bit+0) 
;SERIAL.c,28 :: 		UART1_Init(9600);                  //Se asigna la velocidad del baudrate
	BSF         BAUDCON+0, 3, 0
	MOVLW       4
	MOVWF       SPBRGH+0 
	MOVLW       225
