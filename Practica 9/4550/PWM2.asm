...
;PWM2.c,53 :: 		Set_PWM();                 // Convocamos la función para generar un PWM
	CALL        _Set_PWM+0, 0
;PWM2.c,55 :: 		LEDR = 0;
...
;PWM2.c,58 :: 		Set_PWM();                 // Convocamos la función para generar un PWM
	CALL        _Set_PWM+0, 0
;PWM2.c,61 :: 		LEDA = 1;
...
;PWM2.c,63 :: 		LEDV = 0;
	BCF         LATB1_bit+0, BitPos(LATB1_bit+0) 
;PWM2.c,64 :: 		Set_PWM();                  // Convocamos la función para generar un PWM
	CALL        _Set_PWM+0, 0
;PWM2.c,66 :: 		}
	GOTO        L_main8
;PWM2.c,67 :: 		}
